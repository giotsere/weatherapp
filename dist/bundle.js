...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_0_use_1_node_modules_postcss_loader_dist_cjs_js_style_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
...
const key = __webpack_require__(12);
let cityData =  false || JSON.parse(localStorage.getItem('cityData'));
let forecastData =  false || JSON.parse(localStorage.getItem('forecastData'));
let lat =  false || cityData.coord.lat;
let lon =  false || cityData.coord.lon;
...
const defaultView = __webpack_require__(11);

defaultView.displayDefault();
